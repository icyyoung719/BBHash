...
public:
	...
	// then it will generate internally a sequence of hash values using xorshifts, using these two first hash values as
	// starting point.
...
int main(int argc, char* argv[])
{
	...
	// but could be from a user defined iterator (enabling keys to be read from a file or from some complex
	...
	double gammaFactor = 2.0; // lowest bit/elem is achieved with gamma=1, higher values lead to larger mphf but faster
	                          // construction/query
