...
public:
	...
	// Move constructor
	bitVector(bitVector&& r) noexcept : _bitArray(nullptr), _size(0), _nchar(0) { *this = std::move(r); }
	...
	[[nodiscard]] uint64_t bitSize() const noexcept { return _nchar * 64ULL + _ranks.capacity() * 64ULL; }
